...
image::https://github.com/selingizemozkan/k-means/blob/master/sonsonresim2.png?raw=true[R]
...
image::https://github.com/selingizemozkan/k-means/blob/master/sonsonson2adim.png?raw=true[R]
...
image::https://github.com/selingizemozkan/k-means/blob/master/sonsonson3adimlar.png?raw=true[R]
...
image::https://github.com/selingizemozkan/k-means/blob/master/sonsonson4adimlar.png?raw=true[R]
